...
Packet psqrt_complex(const Packet& a) {
  ...
  // * If z is (x,+â), the result is (+â,+â) even if x is NaN
  // * If z is (x,-â), the result is (+â,-â) even if x is NaN
  // * If z is (-â,y), the result is (0*|y|,+â) for finite or NaN y
  // * If z is (+â,y), the result is (+â,0*|y|) for finite or NaN y
  ...
  // prepare packet of (+â,0*|y|) or (0*|y|,+â), depending on the sign of the infinite real part.
  ...
  // prepare packet of (+â,+â) or (+â,-â), depending on the sign of the infinite imaginary part.
  Packet is_imag_inf;
