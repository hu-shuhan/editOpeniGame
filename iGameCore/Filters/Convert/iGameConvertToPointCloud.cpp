#include "iGameConvertToPointCloud.h"

IGAME_NAMESPACE_BEGIN

bool ConvertToPointCloud::Execute() {
...
bool ConvertToPointCloud::ExecuteWithSurfaceMesh(SurfaceMesh::Pointer OldMesh, PointSet::Pointer NewMesh) {
...
bool ConvertToPointCloud::ExecuteWithVolumeMesh(VolumeMesh::Pointer OldMesh, PointSet::Pointer NewMesh) 
{
    if (OldMesh == nullptr) return false;
...
bool ConvertToPointCloud::ExecuteWithUnstructuredMesh(UnstructuredMesh::Pointer OldMesh, PointSet::Pointer NewMesh) {
    if (OldMesh == nullptr) return false;
