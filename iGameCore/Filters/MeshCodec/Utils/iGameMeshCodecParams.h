...
struct AttrStorageParams : FloatStorageParams {
    std::string name = {};      // 名称
    int32_t type = 0;           // 类型 IG_SCALAR, IG_VECTOR, IG_NORMAL, IG_TCOORD, IG_TENSOR
    int32_t attachmentType = 0; // 附着类型 IG_POINT, IG_CELL
...
inline constexpr uint32_t CodecStorageParamVersion = 1;
