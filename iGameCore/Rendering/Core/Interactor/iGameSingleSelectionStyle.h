...
private:
    //########### FIRST FUNCS ###########
    static int GetFirstPoint(const Point& startPoint, const Point& endPoint,
    ...
    static int GetFirstCell(const Point& startPoint, const Point& endPoint,
                            UnstructuredMesh* mesh,
                            bool selectIgnoreUnSeeAbleCells = false,
                            bool onlySelectSeeAbleCells = false);
    static int GetFirstCell(const Point& startPoint, const Point& endPoint,
