...
public:
    ...
    IntArray* GetBlockMapping() { return m_BlockMapping.get(); }
    void SetBlockMapping(IntArray::Pointer p) { m_BlockMapping = p; }
    bool HasBlockMapping() const { return m_BlockMapping != nullptr; }
...
protected:
    ...
    IntArray::Pointer m_BlockMapping{};
