...
public:
	...
	void SetIndexColor(int index, float rgb[3]) {
		SetIndexColor(index, rgb[0], rgb[1], rgb[2]);
	}
...
private:
	...
	void SetColorRange(FloatArray::Pointer colorrange) {
		this->m_ColorRange = colorrange;
	};
	...
	void InsertIndexColor(int index, float rgb[3]) {
		InsertIndexColor(index, rgb[0], rgb[1], rgb[2]);
	}
