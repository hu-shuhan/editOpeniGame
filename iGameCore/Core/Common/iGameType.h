...
#define IGAME_ABI_ENDIAN_ID_BIG KWIML_ABI_ENDIAN_ID_BIG
#define IGAME_ABI_ENDIAN_ID_LITTLE KWIML_ABI_ENDIAN_ID_LITTLE
#define IGAME_ABI_ENDIAN_ID KWIML_ABI_ENDIAN_ID
#define IGAME_ABI_NO_ERROR_ENDIAN KWIML_ABI_NO_ERROR_ENDIAN
