...
bool iGameSocketConnection::isClientConnected() const
{
...
bool iGameSocketConnection::isRunning() const
{
...
bool iGameSocketConnection::receiveAndProcessCommand()
{
    ...
    while (bytesRead < static_cast<int>(sizeof(dataLength))) {
        int n = recv(m_clientSocket,
                     reinterpret_cast<char*>(&dataLength) + bytesRead,
