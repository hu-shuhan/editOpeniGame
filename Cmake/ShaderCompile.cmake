function(compile_shader SHADERS TARGET_NAME SHADER_INCLUDE_FOLDER GENERATED_DIR GLSLANG_BIN)
    ...
    foreach (SHADER ${SHADERS})
        ...
        message("${GLSLANG_BIN} -I${SHADER_INCLUDE_FOLDER} -G ${SHADER} -o ${SPV_FILE}")
        add_custom_command(
                OUTPUT ${SPV_FILE}
                COMMAND ${GLSLANG_BIN} -I${SHADER_INCLUDE_FOLDER} -G ${SHADER} -o ${SPV_FILE}
                DEPENDS ${SHADER}
        ...
        message(${CMAKE_COMMAND} -DPATH=${SPV_FILE} -DHEADER="${CPP_FILE}")
        add_custom_command(
                OUTPUT ${CPP_FILE}
